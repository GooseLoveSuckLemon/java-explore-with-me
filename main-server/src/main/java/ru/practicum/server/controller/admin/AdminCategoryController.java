...
public class AdminCategoryController extends BaseController {
     ...
     * @throws ru.practicum.server.exception.NotFoundException если категория не найдена
     * @throws ru.practicum.server.exception.ConflictException если новое имя уже занято
     */
    @PatchMapping("/{catId}")
     ...
     * @param catId идентификатор категории (из пути)
     * @throws ru.practicum.server.exception.NotFoundException если категория не найдена
     * @throws ru.practicum.server.exception.ConflictException если категория не пуста (связана с событиями)
     */
    @DeleteMapping("/{catId}")
