...
import ru.practicum.server.service.participation.ParticipationService;
...
public class UserRequestController extends BaseController {
     ...
     * @throws ru.practicum.server.exception.NotFoundException если:
     *         <ul>
     *           <li>Пользователь не найден</li>
     *           <li>Событие не найдено</li>
     *         </ul>
     * @throws ru.practicum.server.exception.ConflictException если:
     *         <ul>
    ...
    public ParticipationRequestDto adaddParticipationRequest(@PathVariable Long userId,
     ...
     *           <li>Событие не найдено</li>
     *         </ul>
     * @throws ru.practicum.server.exception.ConflictException если пользователь
    ...
    public EventRequestStatusUpdateResult changeRequestStatus(@PathVariable Long userId,
                                                              @PathVariable Long eventId,
                                                              @RequestBody EventRequestStatusUpdate request) {
